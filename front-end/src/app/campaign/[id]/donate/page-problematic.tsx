...
export default function DonatePage() {
  ...
  const fetchCampaign = async () => {
    try {
      console.log('DonatePage: Starting to fetch campaign', campaignId);
      setLoading(true);
      setError(null);
      
      const campaignData = await contractService.getCampaign(campaignId);
      console.log('DonatePage: Campaign data received:', campaignData);
      
      if (!campaignData) {
        console.log('DonatePage: No campaign data found');
        setError('Campaign not found');
        return;
      }
      
      console.log('DonatePage: Setting campaign data');
      setCampaign(campaignData);
    } catch (err) {
      console.error('DonatePage: Error fetching campaign:', err);
      setError('Failed to load campaign details');
    } finally {
      console.log('DonatePage: Finished fetching campaign');
      setLoading(false);
    }
  };
