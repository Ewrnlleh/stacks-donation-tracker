...
function RosettaOptionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'reward_cycle_id': !(0, runtime_1.exists)(json, 'reward_cycle_id') ? undefined : json['reward_cycle_id'],
        ...
        'signer_private_key': !(0, runtime_1.exists)(json, 'signer_private_key') ? undefined : json['signer_private_key'],
        'signer_signature': !(0, runtime_1.exists)(json, 'signer_signature') ? undefined : json['signer_signature'],
        'pox_max_amount': !(0, runtime_1.exists)(json, 'pox_max_amount') ? undefined : json['pox_max_amount'],
        'pox_auth_id': !(0, runtime_1.exists)(json, 'pox_auth_id') ? undefined : json['pox_auth_id'],
    };
}
