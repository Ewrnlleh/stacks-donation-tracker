...
class BlocksApi extends runtime.BaseAPI {
     ...
     */
    async getAverageBlockTimesRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.AverageBlockTimesResponseFromJSON)(jsonValue));
    }
    /**
     * Retrieves average block times (in seconds)
     * Get average block times
     */
    async getAverageBlockTimes(initOverrides) {
