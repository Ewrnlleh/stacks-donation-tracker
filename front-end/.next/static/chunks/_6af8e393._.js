...
function DonatePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DonatePage.useEffect": ()=>{
            ...
            const fetchCampaign = {
                "DonatePage.useEffect.fetchCampaign": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        // Add a small delay to ensure proper rendering
                        await new Promise({
                            "DonatePage.useEffect.fetchCampaign": (resolve)=>setTimeout(resolve, 100)
                        }["DonatePage.useEffect.fetchCampaign"]);
...
_s(DonatePage, "f8yySjHXNWbk9v6ea7otEogngrY=", false, function() {
    return [
...
//# sourceMappingURL=_6af8e393._.js.map